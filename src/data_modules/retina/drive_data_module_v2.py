...
class DRIVEDataModule(RetinaDataModule):
    ...
    def __init__(self,
                 ...
                 use_test_as_unlabeled_train_data=False,
                 use_fov=False,
                 train_ratio=0.4,
                 val_ratio=0.2,
                 **kwargs,
        ...
        data_info_path : str
          EITHER
           an existing csv file containing *at least* the following named columns
             dataset,image_path,annotation_path,fov_path
        ...
        use_test_as_unlabeled_train_data : bool, optional
          ...
          Otherwise the test set can be used for training as additional unlabeled data.

        use_fov : bool, optional
          If True, use fov masks in data ibfo file. Otherwise ignore fov masks and set the path to
          empty string

        prepare_data_for_processing : bool, optional
          If True convert ppm to png
    ...
    def _prepare_data_for_processing(self):
        ...
        for imagename in [f'{i:02d}' for i in range(1, 21)]:
            ...
            imsave(fov_png_path, (imread(fov_gif_path) > 0).astype('uint8'), check_contrast=False)
        ...
        for imagename in [f'{i:02d}' for i in range(21, 41)]:
            ...
            imsave(
                annotation_png_path,
                (imread(annotation_gif_path) > 0).astype('uint8'),
